                    ...
                    <div className={styles.forecast}>
                        ...
                        <ul className={styles.forecast__items}>
                            {defaultData[activeIndex] &&
                                defaultData[activeIndex].forecast.map(
                                    (day, index) => (
                                        <li
                                            key={`key_${index}`}
                                        ...
                                        >
                                            ...
                                            <div
                                                className={
                                                    styles.forecast__right
                                                }
                                            >
                                                <div
                                                    className={
                                                        styles.forecast__min
                                                    }
                                                >
                                                ...
                                                <div
                                                    className={
                                                        styles.forecast__line
                                                    }
                                                >
                                                    <span
                                                        className={
                                                            styles.forecast__range
                                                        }
                                                        style={{
                                                            left: `${Math.round(
                                                                day.temp.min
                    ...
                    <div>
                        <div className={styles.today}>
                            <div className={styles.today__title}>
                                Cloudy conditions from 1AM-9AM, with showers
                                expected at 9AM.
                            </div>
